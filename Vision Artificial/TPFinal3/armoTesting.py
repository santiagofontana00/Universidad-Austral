...
if __name__ == "__main__":
    ...
    source_directory = './TPFinal3/databaseASL/asl_dataset'  # Carpeta que contiene las imágenes originales
    testing_directory = './TPFinal3/databaseASL/TPFtesting'  # Carpeta donde quieres mover las imágenes
