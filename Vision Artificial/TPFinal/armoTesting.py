...
if __name__ == "__main__":
    ...
    source_directory = './TPFinal/databaseASL/asl_dataset'  # Carpeta que contiene las imágenes originales
    testing_directory = './TPFinal/databaseASL/TPFtesting'  # Carpeta donde quieres mover las imágenes
